...
@Service
@Log4j2
public abstract class UserServiceImplementation implements UserServices {
...
//			rabbitMQSender.send(mailObject);
	...
	public Users login(LoginInformation information, Object log) {
		Users user = repository.getUser(information.getEmail());
		if (user != null) {
			...
			if (fetchRole.equals(userRole)) {
				...
				System.out.println("you logged in as " + userRole);
				return userInfo;
